...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{assets/figures/lods1.png}
    \caption{Calcul du SSE \cite{3d-tiles-specification}}
    \label{fig:lods-colors}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{assets/figures/lods2.png}
    \caption{Calcul du SSE \cite{3d-tiles-specification}}
    \label{fig:lods-colors}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{assets/figures/lods3.png}
    \caption{Calcul du SSE \cite{3d-tiles-specification}}
    \label{fig:lods-colors}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{assets/figures/lods4.png}
    \caption{Calcul du SSE \cite{3d-tiles-specification}}
    \label{fig:lods-colors}
\end{figure}
